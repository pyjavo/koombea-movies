...
Entrego la estructura del HMTL de la página. Para las convenciones de las clases CSS me guié de [BEM](https://csswizardry.com/2013/01/mindbemding-getting-your-head-round-bem-syntax/), para el grid usé [csswizardry-grids](https://github.com/csswizardry/csswizardry-grids) y para el modal window [fancybox](https://fancyapps.com/fancybox/3/).
